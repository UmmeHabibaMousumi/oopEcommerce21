<div class="header_bottom">
		<div class="header_bottom_left">
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						  <a href="details.php?product_id=<?php echo $result['product_id']; ?>"> <img src="admin/<?php echo $result['image']; ?>" alt="" /></a>
					</div>
					<div class="text list_2_of_1">
						  <h2>Samsung</h2>
						  <p><?php echo $result['product_name']; ?></p>
			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a hr<a href="details.php?product_id=<?php echo $result['product_id']; ?>"> <img src="admin/<?php echo $result['image']; ?>" alt="" /></a>
					</div>
				    <div class="text list_2_of_1">
						<h2>Acer</h2>
						<p><?php echo $result['product_name']; ?></p>
